...
from lesson3.practice.common.variables import PRESENCE, ACTION,  TIME, USER, ACCOUNT_NAME, RESPONSE, \
...
def main():
    ...
    client.connect((server_address, server_port))  # Соединиться с сервером
